...
namespace LibraryOrganizer.Controllers
{
    public class LibrariesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Genre")] Library library)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Genre")] Library library)
        {
            if (id != library.Id)
            {
                return NotFound();
